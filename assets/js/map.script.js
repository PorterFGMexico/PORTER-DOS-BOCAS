...
//  google map 2 function custom ========================== //
	...
	if(jQuery('#gmap_canvas2').length){
		function init_map2() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(18.430333, -93.206148),
			...
			marker2 = new google.maps.Marker({
				map: map2,
				position: new google.maps.LatLng(18.430333, -93.206148),
				optimized: false,
			...
			infowindow2 = new google.maps.InfoWindow({
				content: '<strong>Title</strong><br>Carretera Playas Km. 1.5, Ave. TUM Dos Bocas, Lote TC-3 de la Terminal de Usos Múltiples del Puerto de Dos Bocas<br>'
			});
	...
	if(jQuery('#gmap_canvas4').length){
		function init_map4() {
			...
			marker4 = new google.maps.Marker({
				...
				position: new google.maps.LatLng(18.430333, -93.206148),
				optimized: false,
				icon: new google.maps.MarkerImage('assets/images/marker2.png')
			});
